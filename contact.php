        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 section-title" data-aos="fade-up" data-aos-delay="300">
                    <h2 class="title">Možete nas Kontaktirati putem</h2>
                    <span></span>
                </div>
                <!-- Section Title End -->
            </div>
            <div class="row row-cols-sm-2 row-cols-lg-2 row-cols-1 mb-n6">
                ...
                <div class="col mb-6" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="single-contact-address">
                        ...
                        <p>Adresa: <span>Bulevar Revolucije 268 a.</span></p>
                        <p><span>Grocka, Beograd</span></p>
                    </div>
                ...
                <div class="col mb-6" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="single-contact-address">
                        ...
                        <h4 class="title">Broj telefona</h4>
                        <p>Broj 1: <a href="tel:+3818525278"> +381 8525 278</a></p>
                        <p>Broj2 2: <a href="tel:+381638047342"> +381 63 804 7342</a></p>
                    </div>
                    <!-- Single Contact Address End -->
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="google-map-area w-100">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d698.9602966179282!2d20.685959319408383!3d44.68964991118864!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2srs!4v1633532763636!5m2!1sen!2srs" width="100%" height="600px" style="border:0;" allowfullscreen="" loading="lazy"></iframe></div>
                    <!--Google Map Area Start-->
                </div>
            </div>
        </div>
                        ...
                        <form action="#" id="contact-form" method="post">
                            <div class="row">
                                <div class="col-md-6 col-12 mb-6" data-aos="fade-right" data-aos-delay="300">
                                    <input class="input-item" type="text" placeholder="Puno ime *" name="name">
                                </div>
                                ...
                                <div class="col-12 mb-6" data-aos="fade-up" data-aos-delay="500">
                                    <textarea class="textarea-item" name="message" placeholder="Poruka"></textarea>
                                </div>
                                <div class="col-12" data-aos="fade-up" data-aos-delay="600">
                                    <button class="btn btn-primary btn-hover-dark">Pošaljite nam poruku</button>
                                </div>
                            </div>
                        </form>
